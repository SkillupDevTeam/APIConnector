export const STRICT_EQUALITY_BROKEN = (a, b)=> a===b;
export const STRICT_EQUALITY_NO_NAN = (a, b)=> {
...
export function deepEquals(a, b, areEqual=STRICT_EQUALITY_NO_NAN, setElementsAreEqual=STRICT_EQUALITY_NO_NAN) {
...
export function arraysEqual(a, b, areEqual) {
...
export function objectsEqual(a, b, areEqual) {
...
export function mapsEqual(a, b, areEqual) { // assumes Map's keys use the '===' notion of equality, which is also the assumption of .has and .get methods in the spec; however, Map's values use our notion of the areEqual parameter
    if (a.size!=b.size)
        return false;
